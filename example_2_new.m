...
%% Example 2. Influence of beta_0 and p.
% Change param.beta_0 and param.p for different reconstruction results.

global print_result
print_result = 0;
show_plot = 0;                  % Show plot: 1.
quantitative = 1;               % Compute quantitative estimates: 1.
...
SI_pre = sqrtSI * lsqminnorm(Gp_d' * sqrtSI, param.sig_vec);
II = (Gp_d' * SI * Gp_d);
